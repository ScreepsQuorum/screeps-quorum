...
StructureController.prototype.canSafemode = function() {
  ...
  if (
    this.ticksToDowngrade &&
    CONTROLLER_DOWNGRADE[this.level] - this.ticksToDowngrade >= 5000
  ) {
    return false
  }
  return true
...
if (!StructureController.prototype.unclaimOriginal__notifications) {
  StructureController.prototype.unclaimOriginal__notifications =
    StructureController.prototype.unclaim
